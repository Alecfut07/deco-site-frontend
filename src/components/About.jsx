  ...
  const stats = [
    {
      ...
      value: `${businessInfo?.years_experience || 25}+`,
    },
        ...
        <div className="max-w-4xl mx-auto mb-12 animate-fade-in">
          <p className="text-lg text-foreground leading-relaxed mb-8">
            {businessInfo?.description ||
              "Ortega Reyes Remodeling and Restoration has been transforming homes with exceptional caraftsmanship and dedication for over 25 years. Our team of skilled professionals brings expertise, attention to detail, and a commitment to satisfaction to every project."}
          </p>
